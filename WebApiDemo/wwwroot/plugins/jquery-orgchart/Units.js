...
async function addUnit() {
    ...
    await $.ajax({
        ...
        error: function (result) {
            console.log("An error occured during AJAX request: " + result.responseJSON);
        }
    });
}
    ...
    alertify.confirm("Warning!",
        ...
        function () { // OK
            $.ajax({
                ...
                error: function (result) {
                    console.log("An error occured during AJAX request: " + result.responseText);
                    alertify.alert("Error!", result.responseJSON, function () { // OK
    ...
    alertify.confirm("Warning!",
        ...
        function () { // OK
            $.ajax({
                ...
                error: function (result) {
                    $(".message").text(result.responseJSON);
                    console.log("An error occured during AJAX request: " + result.responseText);
                }
            });
        },
