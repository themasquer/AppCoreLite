...
Encoding.RegisterProvider(CodePagesEncodingProvider.Instance); // for displaying files with windows-1254 ANSI encoding correctly
builder.Services.AddScoped<FileBrowserManagerBase, FileBrowserManager>();
...
builder.Services.AddControllersWithViews().AddNewtonsoftJson(options =>
{
    ...
    options.SerializerSettings.ReferenceLoopHandling = Newtonsoft.Json.ReferenceLoopHandling.Ignore; // to prevent self referencing loop exception for TreeNode
});
