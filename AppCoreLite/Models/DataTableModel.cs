...
namespace AppCoreLite.Models
{
    ...
    public class DtOperationsModel : IConfig
    {
        ...
        public string DetailsCss { get; set; }
        public string EditCss { get; set; }
        public string DeleteCss { get; set; }
        public string OperationLinksProperty { get; set; }
        public string OperationKeyProperty { get; set; }

        public DtOperationsModel()
        {
            DetailsCss = "operationlink";
            EditCss = "operationlink";
            DeleteCss = "operationlink";
            OperationLinksProperty = "OperationLinks";
            OperationKeyProperty = "Id";
            DetailsText = "Detay";
            EditText = "Düzenle";
            DeleteText = "Sil";
            DetailsTitle = "Detay";
        ...
        public void Set(Languages language)
        {
            ...
            DeleteText = language == Languages.Turkish ? "Sil" : "Delete";
            DetailsTitle = language == Languages.Turkish ? "Detay" : "Details";
            EditTitle = language == Languages.Turkish ? "Düzenle" : "Edit";
            DeleteTitle = language == Languages.Turkish ? "Sil" : "Delete";
            DetailsCss = "operationlink";
            EditCss = "operationlink";
            DeleteCss = "operationlink";
            OperationLinksProperty = "OperationLinks";
