    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreEntities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductEntities_CategoryEntities_CategoryEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductStoreEntities", x => new { x.ProductEntityId, x.StoreEntityId });
                    table.ForeignKey(
                        name: "FK_ProductStoreEntities_ProductEntities_ProductEntityId",
                        column: x => x.ProductEntityId,
                        principalTable: "ProductEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductStoreEntities_StoreEntities_StoreEntityId",
                        column: x => x.StoreEntityId,
                        principalTable: "StoreEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductStoreEntities_StoreEntityId",
                table: "ProductStoreEntities",
